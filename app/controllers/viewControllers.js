...
function getLinks(data){
   ...
   itemIndex++;
     parent.insertAdjacentHTML('beforeend',
      '<div class="row" id="list-row"><div class="col-sm-2" id="list-photos"><img src="'+Data.response.groups[0].items[i].venue.featuredPhotos.items[0].prefix+'500x500'+Data.response.groups[0].items[i].venue.featuredPhotos.items[0].suffix+'"></div><div class="col-sm-10" id="inner-list"><span class="badge" id="list-going"><button class="going-class" id="going-btn" value="'+itemIndex+'">'+DataAll[1].rsvp[0][i].length+' going</button></span><p class="poll" id="div-title"><a id="list-title" href="'+Data.response.groups[0].items[i].tips[0].canonicalUrl+'">'+Data.response.groups[0].items[i].venue.name+'</a><span id="list-address">'+Data.response.groups[0].items[i].venue.location.address+', '+Data.response.groups[0].items[i].venue.location.postalCode+'</span><p id="list-rating">Rating: '+Data.response.groups[0].items[i].venue.rating+'</p><p class="poll" id="list-description">"'+Data.response.groups[0].items[i].tips[0].text+'"</p></div></div>');
   }
}
...
var goingButton = document.getElementsByClassName('going-class');
